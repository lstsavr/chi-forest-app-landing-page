...
import { Apple, Smartphone, Bot } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8 p-10 md:p-16 relative z-10">
            ...
            <div className="text-white text-center md:text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                ...
                {/* App Store Button */}
                <a 
                  href="https://space.coze.cn/s/ms3ApBRkSe4/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-black text-white px-6 py-3 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-900 transition-colors shadow-lg"
                >
                  <Apple size={24} />
                ...
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white text-gray-900 px-6 py-3 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors shadow-lg"
                >
                  <Smartphone size={24} />
                  <div className="text-left">
